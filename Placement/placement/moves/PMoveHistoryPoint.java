...
//	pm = m;
    ...
    public boolean acceptedUphill() { return deltaCost > 0 && acceptRandom < acceptProbability; }

    public boolean rejected() { return deltaCost > 0 && acceptRandom > acceptProbability; }
    ...
    public double getProbability() { return acceptProbability; }
