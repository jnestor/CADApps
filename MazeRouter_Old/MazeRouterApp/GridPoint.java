...
class GridPoint implements Comparable {
  ...
  public boolean isSource() {
	...
	return "GridPoint(" + posx + "," + posy  + "," + posz + ")[g=" + gVal + "+ h=" + getHVal() + "=" +fVal + "] q=" + qVal;
    }
    
    public void reset() { gVal = UNROUTED; }
    ...
    // used to bias expansion of "recent" nodes
    private int qVal = 0;
	...
	else return manhattanDistance(tgt); }
